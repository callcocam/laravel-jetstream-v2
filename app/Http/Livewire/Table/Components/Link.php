...
class Link extends Component
{
    ...
    public function destroy($route): self
    {
        return $this->href(function($model) use($route) {
            return route(sprintf('%s.destroy', $route), $this->getUpdatesQueryParameters($model));
        });
    }
    ...
    {
        return $this->href(function($model) use ($route) {
            return route(sprintf('%s.edit', $route), $this->getUpdatesQueryParameters($model));
        });
    }
